...
add_action('init', 'competitors_settings_init');
...
function competitors_text_field_render() {
    $options = get_option('competitors_custom_values');
    ?>
    <textarea cols='40' rows='10' name='competitors_custom_values'><?php echo $options; ?></textarea>
    <?php
}
